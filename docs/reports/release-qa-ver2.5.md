...
| REL-25-07 | リリース阻止 | 恒久修正版build 25004の実機QA未完了 | AndroidはGoogle Play更新、8月9日のいそかぜ、運航状況更新後の予定便保持、JAL経路、履歴・設定、復帰まで合格 | iOS実機、Android USB接続での完全オフライン・復帰、実在臨時便、お気に入り保持待ち |
