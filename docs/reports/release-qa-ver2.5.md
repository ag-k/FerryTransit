...
### iOS TestFlight build 25004実機QA（2026-08-04 00:47–01:09 JST）
...
- 未完了: バックグラウンド移動後、MacロックによりiPhoneミラーリングが停止したため、復帰・コールド起動・完全オフライン→通信復帰は継続する。実在する運航状況臨時便も現在データがなく未確認。
...
| REL-25-07 | リリース阻止 | 恒久修正版build 25004の実機QA未完了 | AndroidとiOSで更新、8月9日のいそかぜ、JAL経路、履歴・設定を確認し、iOSではお気に入り保持も合格 | iOSミラーリング再開、Android USB接続での完全オフライン・復帰、実在臨時便待ち |
