...
### iOS TestFlight build 25004実機QA（2026-08-04 00:47–01:09 / 06:26–10:10 JST）
...
- 未完了: 実在する運航状況臨時便が現在データになく、臨時便追加表示は未確認。iOS build 25004のはつみ交通・船乗換再確認も継続する。
- 判定: iOS build 25004は主要恒久修正、JAL経路、更新保持まで部分合格。REL-25-07は継続する。
...
| REL-25-07 | リリース阻止 | 恒久修正版build 25004の実機QA未完了 | AndroidとiOSで更新、8月9日のいそかぜ、JAL経路、履歴・設定・お気に入り、バックグラウンド・コールド起動、完全通信遮断・復帰を確認済み | iOS build 25004のはつみ交通再確認・実在臨時便待ち |
