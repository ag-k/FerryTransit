  ...
  <div v-if="options.length > 1" class="w-full">
    ...
    >
      <button
        ...
        class="flex min-h-12 flex-1 items-center justify-center gap-2 rounded px-3 py-2 text-sm font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-app-primary/60"
