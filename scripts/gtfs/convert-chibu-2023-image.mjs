...
const STOPS = [
  ...
  stop('kori_school', '学校前', '郡 学校前', 36.01349392, 133.04180702),
  stop('kori_community', 'コミュニティセンター', '郡 コミュニティセンター', 36.01349392, 133.04180702),
  stop('kuri_ferry', 'フェリーターミナル', '来居港フェリーターミナル', 36.0249446, 133.03939755),
