<template>
  <div class="container max-w-[1000px] mx-auto px-4 py-8">
    ...
    <div class="grid md:grid-cols-3 gap-6 mb-12">
      <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 transform hover:-translate-y-1">
        <div class="p-6 text-center">
          <div class="mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="text-blue-600 mx-auto" viewBox="0 0 16 16">
    ...
    <div v-if="hasAlerts" class="mb-6">
      <div class="bg-yellow-100 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg">
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div>
        <h3 class="text-2xl font-semibold mb-4">{{ $t('ABOUT_SERVICE') }}</h3>
        <p class="mb-4">{{ $t('ABOUT_SERVICE_DESC') }}</p>
      ...
      <div>
        <h3 class="text-2xl font-semibold mb-4">{{ $t('CONTACT_INFO') }}</h3>
        <div class="space-y-2">
          <a href="https://www.oki-kisen.co.jp/" target="_blank" class="block p-4 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors group">
            <div class="flex justify-between items-start">
              <h6 class="font-semibold group-hover:text-blue-600">{{ $t('OKI_KISEN') }}</h6>
            ...
            <p class="text-gray-600 text-sm mt-1">{{ $t('OKI_KISEN_DESC') }}</p>
          </a>
          <a href="https://oki-douzen.com/" target="_blank" class="block p-4 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors group">
            <div class="flex justify-between items-start">
              <h6 class="font-semibold group-hover:text-blue-600">{{ $t('OKI_DOUZEN') }}</h6>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-gray-400" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
                <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
              </svg>
            </div>
            <p class="text-gray-600 text-sm mt-1">{{ $t('OKI_DOUZEN_DESC') }}</p>
          </a>
        </div>
      </div>
    </div>
