  ...
  <div class="language-selector">
    ...
    <div class="space-y-2">
      <button v-for="locale in locales" :key="locale.code" @click="switchLocale(locale.code)"
        class="w-full text-left px-4 py-3 rounded-lg border transition-colors duration-200" :class="[
        ...
        <div class="flex items-center justify-between">
          ...
          <svg v-if="currentLocale === locale.code" class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor"
            viewBox="0 0 20 20">
