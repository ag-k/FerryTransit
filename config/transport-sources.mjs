export const TRANSPORT_SOURCE_OPERATIONS = Object.freeze({
  ...
  'okinoshima-town': Object.freeze({
    ...
    feedId: 'okinoshima', conversionTask: 'npm run gtfs:convert:okinoshima:2026'
  }),
  'ama-town': Object.freeze({
    ...
    feedId: 'ama', conversionTask: 'npm run gtfs:convert:ama:r8'
  }),
  'nishinoshima-town': Object.freeze({
    ...
    feedId: 'nishinoshima', conversionTask: 'npm run gtfs:convert:nishinoshima:2026'
  }),
  'chibu-village': Object.freeze({
    ...
    feedId: 'chibu', conversionTask: 'npm run gtfs:convert:chibu:2023'
  }),
  ...
  'ichibata-bus-connection': Object.freeze({
    ...
    feedId: 'ichibata_bus_connection', conversionTask: 'npm run gtfs:convert:ichibata:2026'
  })
})
